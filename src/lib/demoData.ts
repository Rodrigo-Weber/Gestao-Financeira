...
export const demoData: FinanceData = {
  ...
  transactions: [
    ...
    { id: "t2", description: "Aluguel", amount: 1650, kind: "expense", status: "paid", dueDate: date(8), paidDate: date(8), competenceDate: date(8), categoryId: "cat-casa", accountId: "acc-1", source: "manual" },
    { id: "t3", description: "Supermercado", amount: 486.7, kind: "card_purchase", status: "paid", dueDate: date(12), paidDate: date(12), competenceDate: date(12), categoryId: "cat-alimentacao", cardId: "card-1", source: "manual" },
    ...
    { id: "t5", description: "Internet", amount: 119.9, kind: "expense", status: "pending", dueDate: date(22), competenceDate: date(22), categoryId: "cat-casa", accountId: "acc-1", source: "manual" },
    ...
    { id: "t7", description: "Combustível", amount: 220, kind: "card_purchase", status: "paid", dueDate: date(17), paidDate: date(17), competenceDate: date(17), categoryId: "cat-transporte", cardId: "card-1", source: "manual" },
    { id: "t8", description: "Streaming", amount: 55.9, kind: "card_purchase", status: "paid", dueDate: date(19), paidDate: date(19), competenceDate: date(19), categoryId: "cat-lazer", cardId: "card-1", source: "manual" },
  ],
  cards: [
